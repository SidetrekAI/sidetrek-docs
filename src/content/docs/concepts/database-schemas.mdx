...
It will show all the available databases in PostgreSQL. You can always press `q` to come back to the original psql cli. 

Run this command to connect to a database.
