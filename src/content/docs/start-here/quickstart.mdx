...
- Add chart by going to http://localhost:8088/chart/add and selecting a chart type, such as Bar Chart. Click on `CREATE NEW CHART`. Add Metrics and Dimensions. Add the name of the chart. Click on `UPDATE CHART` and `SAVE`
