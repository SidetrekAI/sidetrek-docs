...
<Image
  src="/meltano-job-launch.png"
  alt="meltanojoblaunch"
  width="100%"
  height="100%"
/>
...
- **Customer Distribution by Country**
    ...
    <Image
      src="/customer-distribution-map.png"
      alt="supersetchart"
      width="100%"
      height="100%"
      />
