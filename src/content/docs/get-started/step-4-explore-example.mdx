...
The example code already includes deduping logic in the `staging` stage, but if you'd like more details on this, see the [Deduping](/tutorial/bi-stack-example-iceberg#deduping) section in the BI stack tutorial.
