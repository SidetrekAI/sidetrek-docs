...
![meltano-job-on-dagster](../../../assets/doc-img/1.png)
![meltano-job-launch](../../../assets/doc-img/2.png)
![meltano-job-run-success](../../../assets/doc-img/3.png)
...
![raw-schema-on-minio](../../../assets/doc-img/4.png)
...
In `dbt/your_project/profiles.yml`, you'll see the Trino profile.
...
...
```
In the same file, you'll see how during starting, we create the schema `Raw` in the following lines:
...
![dbt-assets-dagster](../../../assets/doc-img/7.png)
...
![dbt-assets-lineage-dagster](../../../assets/doc-img/8.png)
...
![dbt-assets-materialization](../../../assets/doc-img/9.png)

If the materialization was successful, you should see 3 analytics-ready tables in project_marts schema in minio.

![marts-tables-minio](../../../assets/doc-img/10.png)
...
You can change the username and password from `admin` to anything of your choice in the `docker-init.sh` file inside `superset/docker` directory, where password is set in this line:
```plaintext
ADMIN_PASSWORD="admin"
```
and username is set in this line:
```plaintext {4}
...
1. First download the example dashboard we created for you [here](../../../assets/demo_dashboard.zip)
