...
If you opted to add the example project during `sidetrek init`, Sidetrek has already added and configured the extractor for you. 
...
Where does this `raw` schema come from? 
...
1. First download the example dashboard we created for you [here](@/assets/docs/superset/demo_dashboard.zip)
...
![superset-import](@/assets/docs/step-4-explore-example/11.png)
![superset-import-module](@/assets/docs/step-4-explore-example/12.png)

Find the example dashboard you just added in the list of dashboards and click on it to view it.

![superset-dashboard-list](@/assets/docs/step-4-explore-example/13.png)

That's it! You should now see a bunch of charts we created for you based on the example dataset.

![superset-dashboard-view](@/assets/docs/step-4-explore-example/14.png)
