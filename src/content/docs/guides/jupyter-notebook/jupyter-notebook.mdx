...
If you run `sidetrek start` to start the Sidetrek services, Jupyter Lab will be available at [http://localhost:8889/lab](http://localhost:8889/lab). Default token for authentication is `admin_secret` (see docker-compose.yaml).
